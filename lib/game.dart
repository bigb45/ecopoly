              ...
              Positioned.fill(
                child: Center(
                  child: Container(
                    ...
                    child: Center(
                      child: Text(
                        'Game Over! ${gameManager.winner!.name} won!',
                        style: TextStyle(
                          fontSize: 40,
                          color: Colors.white,
                        ),
...
class GameBoard extends StatelessWidget {
  ...
  const GameBoard({super.key, required this.gameManager});
            ...
            child: LayoutGrid(
              ...
              children: [
                ...
                BoardRow(
                    ...
                    onCityClick: ((index) =>
                        gameManager.openInfoCard(index))).inGridArea('city1'),
                BoardColumn(
                    index: 1,
                    cities: board.sublist(11, 20),
                    onCityClick: ((index) =>
                        gameManager.openInfoCard(index))).inGridArea('city2'),
                BoardRow(
                    index: 2,
                    cities: board.sublist(21, 30),
                    onCityClick: ((index) =>
                        gameManager.openInfoCard(index))).inGridArea('city4'),
                BoardColumn(
                    index: 3,
                    cities: board.sublist(31),
                    onCityClick: ((index) =>
                        gameManager.openInfoCard(index))).inGridArea('city3'),
